...
man_of_steel = media.Movie("Man of Steel", "A very first story of Superman.",
                           "http://upload.wikimedia.org/wikipedia/en/8/85/ManofSteelFinalPoster.jpg",
						   "https://www.youtube.com/watch?v=T6DJcgm3wNY")

# Information of the movie <Avengers II: Age of Ultron>, stored in a Movie instance.
avengers_2 = media.Movie("Avengers II: Age of Ultron", "Reunion of Avengers and their fight to AI.",
...
davinci_code = media.Movie("The Da Vinci Code", "Adventure of a historian.",
                           "http://upload.wikimedia.org/wikipedia/en/e/e9/The_da_vinci_code_final.jpg",
						   "https://www.youtube.com/watch?v=zMba3fckhuQ")

# Information of the movie <Midnight in Paris>, stored in a Movie instance.
midnight_in_paris = media.Movie("Midnight in Paris", "A young man's great love for a city, Paris.",
								"http://upload.wikimedia.org/wikipedia/en/9/9f/Midnight_in_Paris_Poster.jpg",
								"https://www.youtube.com/watch?v=FAfR8omt-CY")

# A list called 'movies' stores all Movie instances created above.
movies = [toy_story, avatar, man_of_steel, avengers_2, davinci_code, midnight_in_paris]
